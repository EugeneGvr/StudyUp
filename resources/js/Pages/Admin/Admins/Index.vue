        ...
        <div class="bg-white rounded shadow overflow-x-auto">
            <table class="w-full whitespace-no-wrap">
                <tr class="text-left font-bold">
                    ...
                    <th class="px-6 pt-6 pb-4">{{$t('Surname')}}</th>
                    <th class="px-6 pt-6 pb-4" colspan="2">{{$t('Email')}}</th>
                </tr>
                <tr v-for="admin in admins.data" :key="admin.id"
                    ...
                    <td class="border-t">
                        <inertia-link class="px-6 py-4 flex items-center" :href="route('admin.admins.show', admin.id)"
                                      tabindex="-1">
                            {{ admin.last_name }}
                        </inertia-link>
                    </td>
                    ...
                    <td class="border-t w-px">
                        <inertia-link class="px-4 flex items-center" :href="route('admin.admins.show', admin.id)"
                                      tabindex="-1">
